<html>
<head>
	<title>Рoссийскиe лoтeрeи на oфициальнoм сайтe</title>
	<meta charset="utf-8">
	...
	<link rel="shortcut icon" href="favicon.ico">
		<link rel="stylesheet" href="css/styleprelend.css?v=001">
	<link rel="stylesheet" href="fonts/BanderaPro/stylesheet.css">
...
define('CAMPAIGN_ID', "f375b7cfec567cdc00b0682bc126f6b5");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'c4a3be00f42581aec882c60d0259bb2e');
define('MP_PARAM_NAME', '__as__id');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', 'bec4e2029fc1dc089f5cc2442d94e53a');
define('CHECK_MCPROXY_VALUE', 'b69a9c944084f64fedcda5d186f4047d9048b822df65da9655c2888c364ffc6a');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '5800.3');
